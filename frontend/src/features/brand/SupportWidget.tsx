...
import { submitSupportTicket } from '@/lib/brandApi';

/**
 * Mirrors features/creator/SupportWidget.tsx — same shared ticket system
 * (routes/support-tickets.js), pointed at the client-side pair of endpoints
 * instead of the inner-circle (creator) pair.
 */
