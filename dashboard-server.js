...
- For suggestedMetrics.activeCreators: this is the STEADY-STATE creator count at Month 7–12 (the peak of the campaign). The model automatically ramps: Month 1–3 = 30% of this number, Month 4–6 = 70%, Month 7–12 = 100%. Do NOT set this to a "starting" or "Phase 1" number. For a typical TikTok shop campaign, Month 7–12 targets should be 100–300 active creators unless the brand explicitly discussed a smaller program. If the transcript mentions a specific starting count (e.g. "we'll start with 20 creators"), multiply by 5–10× for the steady-state target. If no creator count is discussed, default to 150.
