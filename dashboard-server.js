...
app.post('/api/__seed/diamandia-page', express.json(), (req, res) => {
  ...
  const BRIEF = {
    niche: 'Health',
    targetAudience: 'Women aged 33–65 who feel dismissed by their doctors, struggle with unexplained bloating, inflammation, puffiness, or cellulite, and are ready to invest in premium at-home self-care. Particularly resonates with women who have tried everything and want a science-backed ritual they can do in 4 minutes a day.',
    mainProblem: 'The lymphatic system — the body\'s built-in detox and drainage network — goes dormant without daily stimulation, causing water retention, puffiness, cellulite, and chronic inflammation that doctors often dismiss as "just aging."',
    hooks: [
      { text: 'Did you know your body has over 700 lymph nodes that most doctors never talk about? This is what happens when you start activating them every day.', type: 'curiosity' },
      { text: 'I was working out 5 days a week, barely eating, and still gaining weight and bloating. No one told me it was my lymphatic system — until now.', type: 'pain-point' },
      { text: 'I went from looking like a balloon every morning to actually seeing my collarbones again. 4 minutes a day. That\'s it.', type: 'transformation' },
      { text: 'This is NOT a magic cream. NOT a supplement. NOT snake oil. It\'s your body doing exactly what it was designed to do — you just have to turn it on.', type: 'myth-bust' },
      { text: 'You could spend $600 on one lymphatic drainage session — or you could own this for life and do it every single day. I\'ll show you why I chose this.', type: 'controversy' },
      { text: 'I built an entire company around this product by sharing it on Instagram before I even knew what I was doing. Women ages 55–70 are messaging me saying it changed their body more than anything they\'ve ever tried.', type: 'social-proof' },
      { text: 'Your lymphatic system is basically the plumbing of your body. If your toilet is clogged and you flush, what happens? It comes back up. That\'s exactly what inflammation is.', type: 'curiosity' },
      { text: 'POV: You\'re tired of being told that gaining weight, bloating, and feeling like a watermelon is just "normal for your age." It is not normal. Here\'s why.', type: 'pain-point' }
    ],
    frameworks: [
      {
        name: 'The 4-Minute Ritual Demo',
        why: 'This product is physically demonstrable — showing the tool in motion with visible depuffing results is the most powerful conversion driver for a gua sha.',
        outline: [
          'Hook: "I do this for 4 minutes every morning and the difference is insane" (show before face/body)',
          'Demonstrate the gua sha technique on camera — slow, intentional strokes following lymph flow',
          'Show the result or call out what you feel changing (less puffiness, lighter, drained)',
          'Explain WHY it works: "Your lymphatic system has no pump — this IS the pump"',
          'CTA: "Link in bio / tap the shop — I\'ll never go back to not doing this"'
        ]
      },
      {
        name: 'Myth Bust / Reply to Hater',
        why: 'Gua sha sits on the edge of emerging science — skeptics are abundant and engaging them algorithmically outperforms any other format for this product.',
        outline: [
          'Open with a real or fake comment: "This is just a rock lol it does nothing"',
          'Acknowledge it calmly and confidently: "Totally fair. Let me show you the science."',
          'Explain the lymphatic system briefly (700 nodes, no pump, needs activation)',
          'Use the house/plumbing analogy: clogged pipes → waste backs up → inflammation',
          'Close: "You can spend $0 and keep feeling like this, or $75 and give your body what it\'s asking for"'
        ]
      },
      {
        name: 'The Price Justification / Why I Spent the Money',
        why: 'Diamandia has a premium price point — creators need to proactively address sticker shock and reframe the value vs. alternatives.',
        outline: [
          'Hook: "Yes, I spent $150 on this and I\'d do it 100 times again. Here\'s the math."',
          'One lymphatic drainage appointment = $600–$1,000 (NYC price)',
          'This tool: one-time purchase, every single day for life, in your own home',
          'Quality callout: 100% Bian stone, hand-chiseled, no plastic composites — not the $20 Amazon version',
          'CTA: "You\'re not spending money. You\'re ending a subscription to feeling bad."'
        ]
      },
      {
        name: 'Before / After Body Check',
        why: 'Visual transformation is the highest-performing content format for body wellness products — before/after puffiness and sculpting is highly shareable.',
        outline: [
          'Film your face/jawline/body in the morning before the routine (show puffiness, water retention)',
          'Do the full gua sha technique on camera (keep it to 60 seconds of footage)',
          'Film immediately after or next morning showing the visible difference',
          'Speak to the WHY: "Lymphatic drainage pulled the fluid out — this is not weight loss, this is your body doing its job"',
          'Tag the product and drop CTA'
        ]
      },
      {
        name: 'The Permission Slip',
        why: 'Diamandia\'s brand is built around empowering women who have been dismissed — the emotional core of "you deserve 4 minutes" is a unique angle that converts deeply.',
        outline: [
          'Hook: "This video is a permission slip for every woman who says she doesn\'t have time for herself."',
          'Speak directly to the woman juggling kids, career, everyone else\'s needs',
          'Frame 4 minutes as a declaration of self-worth, not a luxury',
          'Show the ritual as a tiny, powerful, daily act of claiming your body back',
          'CTA: "You deserve this. Your body is asking for it. Let\'s go." + shop link'
        ]
      }
    ],
    sampleScripts: [
      {
        framework: 'PAS',
        title: 'Lymphatic Education Hook',
        duration: '~35 seconds',
        script: '[HOOK] Your body has over 700 lymph nodes. And unlike your heart, your lymphatic system has no pump. Nobody tells you this.\n\n[PROBLEM] When your lymphatic system is stagnant, all the waste — the toxins, the fluid, the inflammation — has nowhere to go. It backs up into your body. And you feel it. You look puffy. You feel heavy. Your clothes don\'t fit right even when nothing changed.\n\n[AGITATE] Doctors call it "normal aging." It is not. Your body is asking for help. It just doesn\'t have a pump.\n\n[SOLUTION] This is a DIAMANDIA Body Gua Sha. Bian stone, hand-chiseled, no plastic. You use it for 4 minutes following your lymph flow and you physically give your system the activation it needs. It gets faster over time — like training a muscle.\n\n[CTA] Shop is linked. Start with the Detox Kit. Your body already knows how to do this. It just needs you to show up.'
      },
      {
        framework: 'BAB',
        title: 'The 4-Minute Morning Ritual',
        duration: '~30 seconds',
        script: '[BEFORE] Six months ago I would wake up, look in the mirror, and genuinely feel like a different person had moved into my body overnight. Puffy face, swollen ankles, bloated stomach. Every single morning.\n\n[AFTER] Now I do this for 4 minutes after my shower and I actually recognize myself. My jawline is back. My legs look toned. I feel light.\n\n[BRIDGE] This is the DIAMANDIA Body Gua Sha. It activates your lymphatic system — the drainage network your body already has — and gets it moving. The more consistently you do it, the faster your body responds. It trains like a muscle.\n\n[CTA] The link is in my bio. Start with the Body Gua Sha and the Unapologetic Oil. You will not go back.'
      },
      {
        framework: 'Controversy',
        title: 'Why I Threw Out My $20 Amazon Gua Sha',
        duration: '~30 seconds',
        script: '[HOOK] I have to talk about the $20 gua sha from Amazon. Because I had one. And I need to tell you what\'s in it.\n\n[PROBLEM] Most cheap gua sha tools are resin composites. They have plastic filler. And you are literally dragging plastic across your skin every morning while your body is in a healing, absorbent state.\n\n[SOLUTION] DIAMANDIA uses 100% traditional Chinese Bian stone. Hand-chiseled. No resin, no filler. The stone itself has properties — when you drag it across warm skin it activates lymph flow in a way plastic never could.\n\n[REFRAME] Yes it\'s $85. One lymphatic drainage session in any major city costs $600. You do the math.\n\n[CTA] Shop\'s linked below. Your self-care deserves the real thing.'
      }
    ],
    talkingPoints: {
      benefits: [
        'Activates the lymphatic system in just 4 minutes a day — the body\'s built-in drainage and detox network',
        'Visibly reduces puffiness, water retention, and bloating within days of consistent use',
        '100% traditional Chinese Bian stone and surgical-grade stainless steel — zero plastic, zero resin composites',
        'Cold-pressed organic oils — phthalate-free, cruelty-free, vegan',
        'Replaces $600–$1,000 lymphatic drainage appointments with a one-time tool you own for life',
        'Results compound over time — your lymphatic system literally trains like a muscle and gets more efficient',
        'Handmade, not factory-produced — sourced for the highest potency Bian stone available'
      ],
      objections: [
        '"It\'s too expensive" → Frame it as ROI: one $150 tool vs. $600/session appointments. You\'re not spending money, you\'re ending a subscription to feeling bad.',
        '"Does it actually work?" → Don\'t claim. Demonstrate. Film before/after puffiness. Explain the anatomy — your lymphatic system is real, your nodes are real, drainage is real.',
        '"I don\'t have time" → 4 minutes. Not 4 hours. 4 minutes — less than brushing your teeth twice.'
      ],
      powerPhrases: [
        '"4 minutes a day"',
        '"Your body already knows how to do this — it just needs to be turned on"',
        '"The plumbing of your house"',
        '"Luxury self-care"',
        '"You get what you pay for"',
        '"Feel good in your skin"',
        '"You deserve 4 minutes"',
        '"Unapologetically"'
      ]
    },
    doAndDont: {
      dos: [
        'Demo the product on your actual body — visible before/after puffiness or bloating is the highest-converting content',
        'Use the "4 minutes a day" framing — it makes the commitment feel achievable and triggers impulse buying',
        'Educate first, sell second — the lymphatic system hook creates curiosity that makes people watch to the end',
        'Speak directly to women who feel dismissed by their doctors or told bloating/inflammation is "normal"',
        'Use the plumbing/pipes analogy for the lymphatic system — it lands every time',
        'Call out the quality difference vs. cheap Amazon alternatives — high-potency Bian stone, hand-chiseled, zero plastic',
        'Mention the cost comparison: one session at a lymphatic clinic = $600–$1,000 vs. owning this for life',
        'Post first thing in the morning (7–9am EST) and space content across the day for maximum algo reach'
      ],
      donts: [
        'Don\'t make direct medical claims about cancer, lymph nodes, or chronic illness — keep it in the wellness/body care lane',
        'Don\'t use the word "toxin" on TikTok — use "highest quality ingredients," "organic," or "non-toxic" carefully',
        'Don\'t use fear-based or insecurity messaging — the brand tone is empowerment, permission, and self-worth',
        'Don\'t promise dramatic or rapid results — frame it as a compound daily ritual, not a magic fix',
        'Don\'t position it as weight loss — focus on lymphatic health, depuffing, sculpting, and anti-inflammation',
        'Don\'t delete videos even if they underperform — engagement data from older posts helps TikTok understand your content profile',
        'Don\'t use expired discount codes — delete any video mentioning a code that has ended'
      ]
    },
    benchmarks: {
  ...
  const CREATOR_PAGE = {
    slug: 'diamandia',
    tagName: 'creator-interested-diamandia',
    active: true,
    headline: 'Partner with DIAMANDIA',
    subheadline: 'Join our TikTok Shop creator affiliate program',
    accentColor: '#C9A84C',
    pitch: 'DIAMANDIA is a premium wellness brand built around body gua sha and lymphatic health. We\'re looking for TikTok creators who connect with women who want to feel good in their own skin. Our team reviews every application and reaches out within 48 hours.',
    products: [
      { name: 'Body Gua Sha + Unapologetic Oil', minPrice: '105', url: 'https://www.tiktok.com/t/diamandia' },
      { name: 'Belly Bloat Set', minPrice: '75', url: 'https://www.tiktok.com/t/diamandia' },
      { name: 'Goddess Platinum Trio', minPrice: '200', url: 'https://www.tiktok.com/t/diamandia' },
      { name: 'Muse Body Gua Sha', minPrice: '85', url: 'https://www.tiktok.com/t/diamandia' },
      { name: 'LALA Body Gua Sha', minPrice: '75', url: 'https://www.tiktok.com/t/diamandia' }
    ],
    usps: [
      '100% Traditional Chinese Bian Stone',
      'Hand-chiseled — not factory made',
      'Organic cold-pressed oils',
      'Phthalate-free · Cruelty-free · Vegan',
      '20% commission on every sale'
    ],
    talkingPoints: '4 minutes a day activates your lymphatic system\nVisibly reduces puffiness and water retention\nReplaces $600–$1,000 lymphatic drainage sessions\nOrganic cold-pressed oils — no toxic fillers\nResults compound — your body trains like a muscle',
    campaigns: {},
    brief: BRIEF,
    createdAt: new Date().toISOString(),
  ...
  // Preserve existing campaign links if any
  if (brands.clients[idx].creatorPage?.campaigns) {
    CREATOR_PAGE.campaigns = brands.clients[idx].creatorPage.campaigns;
  }

  brands.clients[idx].creatorPage = CREATOR_PAGE;
  saveBrands(brands);
  console.log('[seed] Diamandia creator page seeded successfully');
  res.json({ ok: true, message: 'Diamandia creator page seeded', slug: 'diamandia' });
});
// ─── END ONE-TIME SEED ─────────────────────────────────────────────────────────
